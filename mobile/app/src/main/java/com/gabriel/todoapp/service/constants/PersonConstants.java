package com.gabriel.todoapp.service.constants;
...
public class PersonConstants {
    ...
    public static final String PERSON_MESSAGE = "message";
    public static final String PERSON_STATUS = "status";
    public static final String PERSON_SUCCESS = "success";
    public static final String PERSON_NOT_FOUND = "not_found";
    public static final String PERSON_OPERATION_EXECUTED = "operation_executed";
