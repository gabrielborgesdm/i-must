...
import com.gabriel.i_must.service.constants.TaskConstants;
import com.gabriel.i_must.service.listeners.APIListener;
import com.gabriel.i_must.service.models.local.LocalTaskModel;
import com.gabriel.i_must.service.models.remote.RemoteTaskModel;
import com.gabriel.i_must.service.models.remote.ResponseTaskModel;
import com.gabriel.i_must.service.models.remote.ResponseTasksModel;
...
public class SyncRepository extends BaseRepository {
    ...
    private final com.gabriel.i_must.service.repositories.remote.TaskRepository mRemoteTaskRepository;
    ...
    public SyncRepository(Context context) {
        super(context);
        mRemoteTaskRepository = new com.gabriel.i_must.service.repositories.remote.TaskRepository(context);
